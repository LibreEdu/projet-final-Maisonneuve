	...
	public function register(){
        ...
        if ($this->form_validation->run() == FALSE) { 
			...
			$config = array(
		  		...
		  		'smtp_port' => 465,
		  		'smtp_user' => 'pachot@gmail.com', // change it to yours
		  		'smtp_pass' => 'Wp1$nvQu4GMDGkZPJhoPJNxzia0NWej6H6sAs3^O24otw3TB6soS&0FNjsQD8G0R%U8iignClNl9zuW%mDqB9Ft1xL%XOSc^8^@q', // change it to yours
		  		'mailtype' => 'html',
		  		'charset' => 'iso-8859-1',
		  		'wordwrap' => TRUE
			);

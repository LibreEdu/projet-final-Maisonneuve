...
abstract class Modele
{
	...
	/**
	 * Suppression d’un ou plusieurs tuples d’une table de la base de données.
	 * 
	...
	/**
	 * Récupère les tuples d’une table selon un critère précis.
	 * 
	...
	/**
	 * Récupère tous les tuples d’une table.
	 * 
	 * @return mixed Jeu de résultats si la requête a été correctement exécutée, false sinon.
	 */

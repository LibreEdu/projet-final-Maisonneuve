          ...
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">             
            ...
            <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
              ...
              <div class="mdl-card__actions">
                <p>
                  <div class='options' data-id='<?php echo $cellier['id'] ?>'>
                    <button class='btnVisiter mdl-button mdl-js-button mdl-button--raised mdl-button--colored'>Visiter</button>
                    <button class='btnSupprimer mdl-button mdl-js-button mdl-button--raised mdl-button--accent'>Supprimer</button>
                  </div>
                </p>
              </div>
            </div>
